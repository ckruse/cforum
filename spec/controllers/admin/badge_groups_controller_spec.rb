  ...
  describe 'POST #create' do
    context 'with valid params' do
      it 'creates a new BadgeGroup' do
        expect do
          post :create, { badge_group: valid_attributes, badges: badges.map(&:badge_id) }, valid_session
  ...
  describe 'PUT #update' do
    context 'with valid params' do
      ...
      it 'updates the requested badge_group' do
        badge_group = BadgeGroup.create! valid_attributes
        put :update, { id: badge_group.to_param, badge_group: new_attributes, badges: badges.map(&:badge_id) }, valid_session
        badge_group.reload
