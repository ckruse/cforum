...
class CfMessagesControllerTest < ActionController::TestCase
  ...
  test "should unaccept on duplicate" do
    ...
    thread   = FactoryGirl.create(:cf_thread, forum: forum, slug: '/2012/dec/6/obi-wan-kenobi')
    message  = FactoryGirl.create(:cf_message, forum: forum, thread: thread)
    message1 = FactoryGirl.create(:cf_message, forum: forum, thread: thread, parent_id: message.message_id, accepted: true)
  ...
  test "should remove accept on first when accepting second" do
    ...
    message  = FactoryGirl.create(:cf_message, forum: forum, thread: thread)
    message1 = FactoryGirl.create(:cf_message, forum: forum, thread: thread, parent_id: message.message_id, accepted: true)
    message2 = FactoryGirl.create(:cf_message, forum: forum, thread: thread, parent_id: message.message_id, accepted: false)
