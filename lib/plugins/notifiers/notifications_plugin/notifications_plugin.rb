...
ApplicationController.init_hooks << Proc.new do |app_controller|
  ...
  app_controller.notification_center.register_hook(CfMessagesController::SHOW_MESSAGE, notifications_plugin)
  app_controller.notification_center.register_hook(CfMessagesController::SHOW_THREAD, notifications_plugin)
end
